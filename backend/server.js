...
app.get("/list/Student", async function (req, res) {
  console.log("Request received to list student");
...
app.post("/deleteStudent", async function (req, res) {
  let reqBody = req.body;
  console.log(
  "Request received to delete religion. Req body: " + JSON.stringify(reqBody)
  );
...
app.post("/editStudent", async function (req, res) {
  let reqBody = req.body;
  let data = await updateStudent(reqBody.name, reqBody.age, reqBody.id, reqBody.religion);
